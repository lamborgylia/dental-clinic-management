#!/usr/bin/env python3
"""
Обновление паролей с правильным bcrypt хешем
"""
...
def update_passwords_correct():
    """Обновляет пароли с правильным bcrypt хешем"""
    ...
    print("🔧 ОБНОВЛЕНИЕ ПАРОЛЕЙ С ПРАВИЛЬНЫМ BCRYPT ХЕШЕМ")
    print("=" * 50)
        ...
        for phone, password in users_data:
            try:
                ...
                if updated_count > 0:
                    ...
                    print(f"   Хеш: {hashed_password.decode('utf-8')[:50]}...")
...
if __name__ == "__main__":
    ...
    success = update_passwords_correct()
    if success:
        print("\n✅ ГОТОВО!")
    else:
        print("\n💥 ОШИБКА!")
