#!/usr/bin/env python3
"""
Скрипт для создания таблиц с минимальными SSL настройками
"""
...
def create_tables_minimal():
    """Создает таблицы с минимальными SSL настройками"""
    ...
    try:
        ...
        # Минимальное подключение - только URL
...
if __name__ == "__main__":
    print("🚀 Создание таблиц с минимальными настройками...")
    success = create_tables_minimal()
    if success:
        print("🎉 Готово!")
        sys.exit(0)
    else:
