#!/usr/bin/env python3
"""
Скрипт для создания записей для администратора (ID=1) на текущую неделю
"""
...
def main():
    print("🚀 Создаем записи для администратора (ID=1) на текущую неделю...")
    ...
    # Создаем много записей для администратора на текущую неделю
    ...
    # Создаем по 20-25 записей в день
    current_day = start_of_week
    while current_day <= end_of_week:
        print(f"\n📅 Создаем записи на {current_day.strftime('%d.%m.%Y')}...")
        
        # Создаем 20-25 записей в день для администратора
    ...
    print(f"\n🎉 Готово!")
    print(f"📅 Создано записей для администратора на текущую неделю: {appointments_created}")
