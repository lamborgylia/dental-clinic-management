#!/usr/bin/env python3
"""
Скрипт для создания таблиц с альтернативным драйвером
"""
...
def create_tables_alternative():
    """Создает таблицы с альтернативным драйвером"""
    ...
    try:
        ...
        # Заменяем psycopg2 на psycopg2-binary в URL
        if 'postgresql://' in database_url:
            database_url = database_url.replace('postgresql://', 'postgresql+psycopg2://')
        
        print(f"📡 Обновленный URL: {database_url[:50]}...")
        
        # Подключение с альтернативными настройками
...
if __name__ == "__main__":
    print("🚀 Создание таблиц с альтернативным драйвером...")
    success = create_tables_alternative()
    if success:
        print("🎉 Готово!")
        sys.exit(0)
    else:
