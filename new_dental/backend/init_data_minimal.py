#!/usr/bin/env python3
"""
Скрипт для инициализации данных с минимальными настройками
"""
...
def init_data_minimal():
    """Инициализирует данные с минимальными настройками"""
...
if __name__ == "__main__":
    print("🚀 Инициализация данных с минимальными настройками...")
    success = init_data_minimal()
    if success:
        print("🎉 Готово!")
        sys.exit(0)
    else:
