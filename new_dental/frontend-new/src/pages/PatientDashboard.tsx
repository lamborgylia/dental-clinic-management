...
const PatientDashboard: React.FC = () => {
  ...
  useEffect(() => {
    setTeethServices(getAllTeethWithServices());
  }, [treatmentPlans]);
                  ...
                  <div key={plan.id} style={{ 
                    ...
                    <div style={{ 
                      ...
                      <div style={{
                        ...
                        <span style={{
                          backgroundColor: plan.status === 'active' ? '#059669' : '#6b7280',
                          color: 'white',
                      ...
                      <div style={{ 
                        ...
                        <div>
                          ...
                          <div style={{ marginTop: '0.25rem' }}>
                            {plan.selected_teeth.map(toothId => (
                    ...
                    {appointments.map(appointment => (
                      <tr key={appointment.id}>
                        ...
                        <td style={{ 
                          ...
                          <span style={{
                            backgroundColor: appointment.status === 'scheduled' ? '#f59e0b' : '#059669',
                            color: 'white',
                            padding: 'clamp(0.25rem, 1vw, 0.5rem) clamp(0.5rem, 2vw, 0.75rem)',
                            borderRadius: '1rem',
                            fontSize: 'clamp(0.75rem, 2vw, 0.875rem)',
                            ...
                            {appointment.status === 'scheduled' ? 'Запланирован' : 'Завершен'}
                          </span>
                        </td>
                        <td style={{ 
                          padding: 'clamp(0.75rem, 2vw, 1rem)', 
