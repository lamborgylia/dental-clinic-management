#!/usr/bin/env python3
"""
Скрипт для создания API эндпоинта деплоя
"""
...
def create_deploy_endpoint():
    """Создает файл с API эндпоинтом для деплоя"""
...
'''
    ...
    # Создаем файл
    with open('deploy_endpoint.py', 'w', encoding='utf-8') as f:
        f.write(endpoint_code)
    
    print("✅ Файл deploy_endpoint.py создан!")
    print("📋 Теперь нужно:")
    print("1. Скопировать содержимое в app/routers/deploy.py")
    print("2. Добавить router в main.py")
    print("3. Перезапустить сервер")
    print("4. Отправить POST запрос на /deploy-database")
